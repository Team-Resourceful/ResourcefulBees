...
public final class  ModPaths {
    ...
    public static final Path MOD_ROOT = PathUtils.getModPath(BeeConstants.MOD_ID);
    ...
    private static Path createCustomPath(String pathName) {
        Path customPath = Paths.get(PathUtils.getConfigPath().toAbsolutePath().toString(), BeeConstants.MOD_ID, pathName);
