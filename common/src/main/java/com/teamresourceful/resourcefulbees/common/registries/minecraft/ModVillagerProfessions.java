...
public final class ModVillagerProfessions {
    ...
    public static final ResourcefulRegistry<VillagerProfession> PROFESSIONS = ResourcefulRegistries.create(BuiltInRegistries.VILLAGER_PROFESSION, ModConstants.MOD_ID);
