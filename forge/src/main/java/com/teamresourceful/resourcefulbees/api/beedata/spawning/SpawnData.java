...
public class SpawnData {
    ...
    public MobSpawnSettings.SpawnerData getSpawnerData(EntityType<?> entityType, boolean isFlowerForest) {
        return new MobSpawnSettings.SpawnerData(entityType, isFlowerForest ? spawnWeight + Config.BEE_FLOWER_FOREST_MULTIPLIER.get() : spawnWeight, minGroupSize, maxGroupSize);
    }
     ...
     * hostile mobs other than the different {@link MobCategory}s.
     *
