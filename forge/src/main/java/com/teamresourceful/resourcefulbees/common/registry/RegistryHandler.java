...
public final class RegistryHandler {
    ...
    public static void init() {
        ...
        com.teamresourceful.resourcefulbees.common.registries.minecraft.ModEffects.EFFECTS.init();
        ...
        ModPOIs.POIS.init();
        com.teamresourceful.resourcefulbees.common.registries.minecraft.ModPotions.POTIONS.init();
