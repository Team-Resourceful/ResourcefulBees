...
public class TraitRegistry implements ITraitRegistry {
    ...
    public static void registerDefaultTraits() {
        getRegistry().register(TraitConstants.WITHER, new BeeTrait.Builder(TraitConstants.WITHER).addPotionImmunity(MobEffects.WITHER).addDamagePotionEffect(Pair.of(MobEffects.WITHER, 1)).setBeepediaItem(Items.WITHER_ROSE).build());
        ...
        getRegistry().register(TraitConstants.ZOMBIE, new BeeTrait.Builder(TraitConstants.ZOMBIE).addDamagePotionEffect(Pair.of(MobEffects.HUNGER, 20)).setBeepediaItem(Items.ROTTEN_FLESH).build());
        getRegistry().register(TraitConstants.PIGMAN, new BeeTrait.Builder(TraitConstants.PIGMAN).addDamagePotionEffect(Pair.of(MobEffects.DIG_SLOWDOWN, 0)).setBeepediaItem(Items.GOLD_NUGGET).build());
        ...
        getRegistry().register(BeeConstants.OREO_BEE, new BeeTrait.Builder(BeeConstants.OREO_BEE).addDamagePotionEffect(Pair.of(MobEffects.HEAL, 2)).setBeepediaItem(ModItems.OREO_COOKIE.get()).build());
        getRegistry().register(BeeConstants.KITTEN_BEE, new BeeTrait.Builder(BeeConstants.KITTEN_BEE).addDamagePotionEffect(Pair.of(MobEffects.MOVEMENT_SPEED, 2)).setBeepediaItem(Items.RED_BED).build());
