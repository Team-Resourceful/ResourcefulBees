//package com.teamresourceful.resourcefulbees.gametest.recipes;
//
...
//    private static final SolidificationRecipe RECIPE = new SolidificationRecipe(TEST_ID, new RecipeFluid(Fluids.WATER), new ItemStack(Items.STICK));
