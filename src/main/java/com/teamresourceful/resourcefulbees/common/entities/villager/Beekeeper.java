...
//import com.teamresourceful.resourcefulbees.events.RegisterVillagerTradesEvent;
...
//        addTrade(4, event, UniformInt.of(16,32), Items.GRASS_BLOCK, UniformInt.of(8,24), nest, UniformInt.of(1,1), 4, 0.02f, 3);
//    }
//
