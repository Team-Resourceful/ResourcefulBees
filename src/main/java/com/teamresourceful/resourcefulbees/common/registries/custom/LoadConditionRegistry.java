...
public final class LoadConditionRegistry {
    ...
    private static final LoadConditionSerializer<FakeCondition> DUMMY_SERIALIZER = LoadConditionSerializer.of(ResourcefulBees.id("noop"), Codec.unit(FakeCondition::new));
