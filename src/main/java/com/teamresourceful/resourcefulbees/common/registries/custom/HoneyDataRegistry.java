...
public final class HoneyDataRegistry {
    ...
    private static final HoneyDataSerializer<DummyHoneyData> DUMMY_SERIALIZER = HoneyDataSerializer.of(ResourcefulBees.id("noop"), 0, id -> Codec.unit(DummyHoneyData::new), new DummyHoneyData());
