...
public final class BeeDataRegistry {
    ...
    private static final BeeDataSerializer<DummyBeeData> DUMMY_SERIALIZER = BeeDataSerializer.of(ResourcefulBees.id("noop"), 0, id -> Codec.unit(DummyBeeData::new), new DummyBeeData());
