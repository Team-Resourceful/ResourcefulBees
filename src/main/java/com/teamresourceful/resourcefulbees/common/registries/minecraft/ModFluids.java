...
public final class ModFluids {
    private ModFluids() throws UtilityClassException {
    ...
    public static final ResourcefulFluidRegistry FLUID_TYPES = ResourcefulRegistries.create(ResourcefulRegistryType.FLUID, ModConstants.MOD_ID);
