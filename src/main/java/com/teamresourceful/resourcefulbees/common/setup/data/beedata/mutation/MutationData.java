...
public record MutationData(int count, ResourceLocation id) implements BeeMutationData {
    ...
    private static final BeeMutationData DEFAULT = new MutationData(0, ResourcefulBees.id("empty"));
    ...
    public static final BeeDataSerializer<BeeMutationData> SERIALIZER = BeeDataSerializer.of(ResourcefulBees.id("mutation"), 1, id -> CODEC, DEFAULT);
