...
public record CustomHoneyFluidData(
    ...
    public static final HoneyDataSerializer<HoneyFluidData> SERIALIZER = HoneyDataSerializer.of(ResourcefulBees.id("fluid"), 1, CustomHoneyFluidData::codec, DEFAULT);
