...
public record LayerData(
        ...
        String bone
) implements BeeLayerData {

    public static final BeeLayerData DEFAULT = new LayerData(Color.DEFAULT, LayerTexture.MISSING_TEXTURE, LayerEffect.NONE, false, 0, "body");
    ...
    public static final Codec<BeeLayerData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.STRING.optionalFieldOf("bone", "body").forGetter(BeeLayerData::bone)
