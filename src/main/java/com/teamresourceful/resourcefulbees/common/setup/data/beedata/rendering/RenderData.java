...
public record RenderData(Set<BeeLayerData> layers, BeeColorData colorData, ResourceLocation model, BeeLayerTexture texture, ResourceLocation animations, float sizeModifier) implements BeeRenderData {
    ...
    private static final ResourceLocation BASE_MODEL = ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "geo/base.geo.json");
    private static final ResourceLocation BASE_ANIMATION = ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "animations/bee.animation.json");
