...
public record RenderData(Set<BeeLayerData> layers, BeeColorData colorData, Identifier model, BeeLayerTexture texture, Identifier animations, float sizeModifier) implements BeeRenderData {

    private static final Identifier BASE_MODEL = Identifier.fromNamespaceAndPath(ModConstants.MOD_ID, "geo/base.geo.json");
    private static final Identifier BASE_ANIMATION = Identifier.fromNamespaceAndPath(ModConstants.MOD_ID, "animations/bee.animation.json");
    ...
    private static final Codec<BeeRenderData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Identifier.CODEC.optionalFieldOf("animation", BASE_ANIMATION).forGetter(BeeRenderData::animations),
