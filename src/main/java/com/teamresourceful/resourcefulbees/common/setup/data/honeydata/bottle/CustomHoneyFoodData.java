...
public record CustomHoneyFoodData(int nutrition, float saturation, boolean canAlwaysEat, boolean consumeSeconds, List<HoneyBottleEffectData> effects) implements HoneyFoodData {
    ...
    public static final Codec<HoneyFoodData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.BOOL.optionalFieldOf("fastFood", false).forGetter(HoneyFoodData::consumeSeconds),
