...
public record CustomHoneyFoodData(int nutrition, float saturation, boolean canAlwaysEat, float consumeSeconds, List<HoneyBottleEffectData> effects) implements HoneyFoodData {

    public static final CustomHoneyFoodData DEFAULT = new CustomHoneyFoodData(1, 1f, false, 2f, List.of());
