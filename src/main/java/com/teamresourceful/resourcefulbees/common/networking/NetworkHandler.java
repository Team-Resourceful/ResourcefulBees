...
public final class NetworkHandler {
    ...
    public static final Network CHANNEL = new Network(
        ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "main"),
        0
    );

    public static void init() {
        CHANNEL.register(NetworkDirection.CLIENT_TO_SERVER, BeeconChangePacket.ID, BeeconChangePacket.HANDLER, BeeconChangePacket.class);
