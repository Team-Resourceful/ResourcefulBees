...
public record DimensionalBeesPacket(
    ...
    public static final ClientboundPacketType<DimensionalBeesPacket> PACKET_TYPE = new DimensionalBeesPacket.Type();
    ...
    private static class Type extends CodecPacketType<DimensionalBeesPacket> implements ClientboundPacketType<DimensionalBeesPacket> {
