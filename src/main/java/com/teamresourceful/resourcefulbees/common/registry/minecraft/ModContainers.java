...
public class ModContainers {
    ...
    public static final RegistryObject<MenuType<HoneyCongealerContainer>> SOLIDIFICATION_CHAMBER_CONTAINER = CONTAINER_TYPES.register("solidification_chamber", () -> IForgeMenuType
