...
public record TankData(FluidStack fluid, int capacity) {
    ...
    private static final Codec<TankData> CODEC = RecordCodecBuilder.create(i -> i.group(
    ...
    private static final StreamCodec<RegistryFriendlyByteBuf, TankData> STREAM_CODEC = StreamCodec.composite(
