...
public record FluidRenderData(Color color, ResourceLocation still, ResourceLocation flowing, ResourceLocation overlay) {
    ...
    public static final FluidRenderData DEFAULT = new FluidRenderData(Color.DEFAULT, CUSTOM_FLUID_STILL, CUSTOM_FLUID_FLOWING, CUSTOM_FLUID_OVERLAY);
    ...
    public static final Codec<FluidRenderData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            ResourceLocation.CODEC.fieldOf("overlayTexture").orElse(CUSTOM_FLUID_OVERLAY).forGetter(FluidRenderData::overlay)
