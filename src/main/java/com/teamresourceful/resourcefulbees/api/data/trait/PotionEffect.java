...
public record PotionEffect(Holder<MobEffect> effect, int strength) {
    ...
    public static final Codec<PotionEffect> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            BuiltInRegistries.MOB_EFFECT.holderByNameCodec().fieldOf("effect").orElse(MobEffects.LUCK).forGetter(PotionEffect::effect),
