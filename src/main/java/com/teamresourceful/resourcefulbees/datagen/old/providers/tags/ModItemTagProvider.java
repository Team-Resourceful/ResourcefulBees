//package com.teamresourceful.resourcefulbees.datagen.old.providers.tags;
//
...
//        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "honeycombs"))).add(Items.HONEYCOMB);
//        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/honeycombs"))).add(Items.HONEYCOMB_BLOCK);
//        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "buckets/honey"))).add(ModItems.HONEY_BUCKET.get());
//        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "honey_blocks"))).add(Items.HONEY_BLOCK);
//        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "honey_bottles"))).add(Items.HONEY_BOTTLE);
...
//        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "wax"))).add(ModItems.WAX.get());
//        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "storage_blocks/wax"))).add(ModItems.WAX_BLOCK_ITEM.get());
//        tag(Tags.Items.STORAGE_BLOCKS).addTags(ModItemTags.WAX_BLOCK);
//        tag(TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("c", "heat_sources")))
