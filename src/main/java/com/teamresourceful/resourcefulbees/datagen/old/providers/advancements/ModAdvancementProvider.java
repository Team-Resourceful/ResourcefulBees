//package com.teamresourceful.resourcefulbees.datagen.old.providers.advancements;
//
...
//import com.teamresourceful.resourcefulbees.datagen.old.bases.BaseAdvancementProvider;
...
//                ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "textures/gui/advancements/backgrounds/resourcefulbees.png"),
...
//                .build(ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "resourcefulbees/obtain_bee_nest")));
//
...
//                ))
//                .build(ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "resourcefulbees/beepedia_unlock_bee")));
//
//
...
//                ))
//                .build(ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "resourcefulbees/beepedia_complete")));
//
//            ItemStack filledJar =  BeeJarItem.createFilledJar(ResourceLocation.bySeparator("minecraft:bee", ':'), Color.parseColor("#edc343"));
//
...
//                ))
//                .build(ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "resourcefulbees/collect_bee"))
//            );
//
//            ItemStack kittenJar = BeeJarItem.createFilledJar(ResourceLocation.bySeparator("resourcefulbees:kitten_bee", ':'), Color.parseColor("#EAA939"));
//
...
//                ))
//                .build(ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "resourcefulbees/kitten_bee"))
//            );
//
//            ItemStack oreoJar = BeeJarItem.createFilledJar(ResourceLocation.bySeparator("resourcefulbees:oreo_bee", ':'), Color.parseColor("#442920"));
//
...
//                ))
//                .build(ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "resourcefulbees/oreo_bee"))
//            );
//        }
//
//        @Override
