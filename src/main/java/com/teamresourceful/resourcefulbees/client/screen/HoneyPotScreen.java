...
public class HoneyPotScreen extends AbstractContainerScreen<HoneyPotMenu> {
    ...
    private static final ResourceLocation BACKGROUND = ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "textures/gui/honey_tank/honey_pot.png");
    ...
    protected void renderBg(@NotNull GuiGraphics graphics, float partialTicks, int x, int y) {
        ...
        /*todo FluidHolder holder = menu.getEntity().getFluid();
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        /*todo if (MathUtils.inRangeInclusive(mouseX, leftPos+129, leftPos+141) && MathUtils.inRangeInclusive(mouseY, topPos+16, topPos+70)) {
