...
//
//    enum Category {
//        POTIONS(ResourceLocation.parse("textures/item/brewing_stand.png"), BeepediaTranslations.Traits.POTION_DAMAGE_EFFECTS),
//        IMMUNITIES(ResourceLocation.parse("textures/item/barrier.png"), BeepediaTranslations.Traits.IMMUNITIES),
//        DAMAGE(ResourceLocation.parse("textures/item/iron_axe.png"), BeepediaTranslations.Traits.DAMAGE_TYPES),
//        ABILITIES(ResourceLocation.parse("textures/item/nether_star.png"), BeepediaTranslations.Traits.ABILITIES),
//        AURAS(ResourceLocation.parse("textures/item/end_crystal.png"), BeepediaTranslations.Traits.AURAS);
//
