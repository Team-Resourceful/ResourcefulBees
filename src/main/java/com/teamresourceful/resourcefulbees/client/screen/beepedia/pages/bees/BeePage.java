...
public class BeePage extends SubdividedScreen {
    ...
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "textures/gui/beepedia/bee_splitter.png");
    ...
    protected void init() {
        ...
        if (honeycomb.isPresent()) {
            x+=22;
            addRenderableWidget(new SlotButton(x, 25, BeepediaTextures.HONEYCOMB, () -> false,
