...
public class BeepediaScreen extends SubdividedScreen {
    ...
    public static final ResourceLocation STATE_ID = ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "beepedia");
    public static final ResourceLocation BACKGROUND = ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "textures/gui/beepedia/screen.png");
