...
public class HoneycombEntry extends BaseListEntry {
    ...
    public static final ResourceLocation ROW_TEXTURE = ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "textures/gui/beepedia/honeycomb.png");
    public static final ResourceLocation SLOT_TEXTURE = ResourceLocation.fromNamespaceAndPath(ModConstants.MOD_ID, "textures/gui/beepedia/list_button.png");
