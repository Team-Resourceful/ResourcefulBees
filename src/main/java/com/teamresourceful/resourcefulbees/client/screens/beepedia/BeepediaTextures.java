...
public class BeepediaTextures {
    ...
    public static final ResourceLocation MUTATION = new ResourceLocation(ResourcefulBees.MOD_ID, "textures/gui/beepedia/mutation_icon.png");
    public static final ResourceLocation HOMEYCOMB = new ResourceLocation("textures/item/honeycomb.png");
    public static final ResourceLocation COMPASS = new ResourceLocation("textures/item/compass_00.png");
    public static final ResourceLocation RECIPE_BOOK = new ResourceLocation("textures/item/knowledge_book.png");
    public static final ResourceLocation FLOWER = new ResourceLocation(ResourcefulBees.MOD_ID, "textures/block/gold_flower.png");
    public static final ResourceLocation EXTRA_INFO = new ResourceLocation("textures/item/enchanted_book.png");
