...
public class BeepediaState implements ScreenState {
    ...
    public BeepediaState.Type type = BeepediaState.Type.BEES;
    public PageState<BeepediaScreen> page = null;


    private Pair<BeepediaState.Sorting, TriState> sorting = Pair.of(BeepediaState.Sorting.ALPHABETICAL, TriState.TRUE);
    public String search = null;

    public void setSorting(BeepediaState.Sorting sorting, @Nullable TriState value) {
        this.sorting = Pair.of(sorting, value);
    }

    public TriState getSorting(BeepediaState.Sorting sorting) {
