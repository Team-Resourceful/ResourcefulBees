...
//
//            AnimationState<PetModelData> event = new AnimationState<>(data, 0, 0, partialTicks, true); //TODO partialTicks?
//            provider.setCustomAnimations(data, renderer.getInstanceId(data), event);
//            renderer.reRender(model, stack, buffer, data, renderType, consumer, partialTicks, packedLightIn, OverlayTexture.NO_OVERLAY, 1);
//
