...
public class CentrifugeRenderer <R extends BlockEntityRenderState & GeoRenderState> extends GeoBlockRenderer<CentrifugeBlockEntity, @NonNull R> {
    public CentrifugeRenderer(BlockEntityRendererProvider.Context context, BlockEntityType<CentrifugeBlockEntity> blockEntityType) {
