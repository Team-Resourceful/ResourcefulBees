...
public final class PetInfo {
    ...
    private static final PetModelData FALLBACK_MODEL = new PetModelData(-1, "fallback", ResourceLocation.tryParse("resourcefulbees:geo/base-nocloak.geo.json"), ResourceLocation.tryParse("textures/entity/bee/bee.png"), Optional.empty(), new HashSet<>());
