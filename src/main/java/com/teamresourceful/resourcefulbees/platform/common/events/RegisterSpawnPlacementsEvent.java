...
public record RegisterSpawnPlacementsEvent(Registry registry) {
    ...
    public <T extends Mob> void register(EntityType<T> entityType, @NotNull SpawnPlacementType placementType, @NotNull Heightmap.Types heightmap, SpawnPlacements.SpawnPredicate<T> predicate) {
    ...
    public interface Registry {
        ...
        <T extends Mob> void register(EntityType<T> entityType, @NotNull SpawnPlacementType placementType, @NotNull Heightmap.Types heightmap, SpawnPlacements.SpawnPredicate<T> predicate);
    }
}
