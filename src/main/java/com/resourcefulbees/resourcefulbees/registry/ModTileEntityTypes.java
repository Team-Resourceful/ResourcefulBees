...
public class ModTileEntityTypes {
    ...
    public static final RegistryObject<TileEntityType<?>> TIERED_BEEHIVE_TILE_ENTITY = TILE_ENTITY_TYPES.register("tiered_beehive", () -> TileEntityType.Builder
            .of(TieredBeehiveTileEntity::new, ModBlocks.T1_BEEHIVE.get(), ModBlocks.T2_BEEHIVE.get(), ModBlocks.T3_BEEHIVE.get(), ModBlocks.T4_BEEHIVE.get(), ModBlocks.ACACIA_BEE_NEST.get(), ModBlocks.GRASS_BEE_NEST.get(), ModBlocks.JUNGLE_BEE_NEST.get(), ModBlocks.NETHER_BEE_NEST.get(),
    ...
    public static final RegistryObject<TileEntityType<?>> CENTRIFUGE_ENTITY = TILE_ENTITY_TYPES.register("centrifuge", () -> TileEntityType.Builder
            .of(() -> new CentrifugeTileEntity(ModTileEntityTypes.CENTRIFUGE_ENTITY.get()), ModBlocks.CENTRIFUGE.get())
            .build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> CENTRIFUGE_CONTROLLER_ENTITY = TILE_ENTITY_TYPES.register("centrifuge_controller", () -> TileEntityType.Builder
            .of(() -> new CentrifugeControllerTileEntity(ModTileEntityTypes.CENTRIFUGE_CONTROLLER_ENTITY.get()), ModBlocks.CENTRIFUGE_CONTROLLER.get())
            .build(null));
    public static final RegistryObject<TileEntityType<?>> CENTRIFUGE_CASING_ENTITY = TILE_ENTITY_TYPES.register("centrifuge_casing", () -> TileEntityType.Builder
            .of(() -> new CentrifugeCasingTileEntity(ModTileEntityTypes.CENTRIFUGE_CASING_ENTITY.get()), ModBlocks.CENTRIFUGE_CASING.get())
            .build(null));
    ...
    public static final RegistryObject<TileEntityType<?>> ELITE_CENTRIFUGE_CONTROLLER_ENTITY = TILE_ENTITY_TYPES.register("elite_centrifuge_controller", () -> TileEntityType.Builder
            .of(() -> new EliteCentrifugeControllerTileEntity(ModTileEntityTypes.ELITE_CENTRIFUGE_CONTROLLER_ENTITY.get()), ModBlocks.ELITE_CENTRIFUGE_CONTROLLER.get())
            .build(null));
