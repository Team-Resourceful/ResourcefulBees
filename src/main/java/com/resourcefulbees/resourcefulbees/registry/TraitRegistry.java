...
public class TraitRegistry implements ITraitRegistry {
    ...
    public static TraitRegistry getRegistry() { return INSTANCE; }
     ...
     */
    public BeeTrait getTrait(String name) { return TRAIT_REGISTRY.get(name); }
     ...
     */
    public Map<String, BeeTrait> getTraits() { return Collections.unmodifiableMap(TRAIT_REGISTRY); }
