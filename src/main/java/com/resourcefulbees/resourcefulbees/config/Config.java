...
public class Config {
    ...
    public static class CommonConfig {
        ...
        static {
            ...
            MULTIBLOCK_RECIPE_TIME_REDUCTION = COMMON_BUILDER.comment("\nTick reduction applied to centrifuge recipes","This does not affect recipes that are not auto generated by us.","NOTE: Lowest recipe time allowed is 10 ticks regardless of values provided.")
                    .defineInRange("multiblockRecipeTimeReduction", 100,10,1200);
            ...
            RF_TICK_CENTRIFUGE = COMMON_BUILDER.comment("\nRF/t consumed by the centrifuge when processing recipes. Mutliblock Centrifuge cuts this value in half.")
                    .defineInRange("centrifugeRfPerTick", 2,2,1000);
