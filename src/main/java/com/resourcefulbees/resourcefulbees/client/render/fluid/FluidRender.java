...
public class FluidRender {
    ...
    public static void setHoneyRenderType() {
        ...
        RenderTypeLookup.setRenderLayer(ModFluids.STARRY_HONEY_FLOWING.get(), RenderType.translucent());
        RenderTypeLookup.setRenderLayer(ModFluids.STARRY_HONEY_STILL.get(), RenderType.translucent());
        RenderTypeLookup.setRenderLayer(ModBlocks.STARRY_HONEY_BLOCK.get(), RenderType.translucent());
        RenderTypeLookup.setRenderLayer(ModBlocks.STARRY_HONEY_FLUID_BLOCK.get(), RenderType.translucent());
    }
}
